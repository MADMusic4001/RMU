...
/**
 * Database schema data for the creature_specialization_ranks table
 */
public interface CreatureSpecializationRanksSchema {
    String TABLE_NAME = "creature_specialization_ranks";
    ...
    String[] COLUMNS = new String[] {COLUMN_CREATURE_ID, COLUMN_SPECIALIZATION_ID, COLUMN_RANKS};
}
