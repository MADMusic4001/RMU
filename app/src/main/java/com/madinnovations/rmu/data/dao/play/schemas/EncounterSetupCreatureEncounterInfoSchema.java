 ...
 */
public interface EncounterSetupCreatureEncounterInfoSchema {
	String TABLE_NAME = "encounter_setup_creature_encounter_info";
	...
	String TABLE_CREATE = "CREATE TABLE IF NOT EXISTS "
			...
			+ "PRIMARY KEY(" + COLUMN_ENCOUNTER_SETUP_ID + "," + COLUMN_CREATURE_ID + "), "
			+ "FOREIGN KEY (" + COLUMN_ENCOUNTER_SETUP_ID + ") "
				+ " REFERENCES " + EncounterSetupSchema.TABLE_NAME + "(" + EncounterSetupSchema.COLUMN_ID + "));";

	String[] COLUMNS = new String[] {COLUMN_ENCOUNTER_SETUP_ID, COLUMN_CREATURE_ID, COLUMN_LOCATION_X, COLUMN_LOCATION_Y,
