...
public interface CharacterTalentParametersSchema {
    ...
    String TABLE_CREATE = "CREATE TABLE IF NOT EXISTS "
            ...
            + "PRIMARY KEY(" + COLUMN_CHARACTER_ID + "," + COLUMN_TALENT_ID + "," + COLUMN_PARAMETER_NAME + ")"
            + ")";

    String[] COLUMNS = new String[] {COLUMN_CHARACTER_ID, COLUMN_TALENT_ID, COLUMN_PARAMETER_NAME, COLUMN_INT_VALUE,
			COLUMN_ENUM_NAME};
}
