 ...
 */
public interface CombatSetupCharacterCombatInfoSchema {
	String TABLE_NAME = "combat_setup_character_combat_info";
	...
	String TABLE_CREATE = "CREATE TABLE IF NOT EXISTS "
			...
			+ "PRIMARY KEY(" + COLUMN_COMBAT_SETUP_ID + "," + COLUMN_CHARACTER_ID + ")"
			+ ")";

	String[] COLUMNS = new String[] {COLUMN_COMBAT_SETUP_ID, COLUMN_CHARACTER_ID, COLUMN_LOCATION_X, COLUMN_LOCATION_Y,
