...
/**
 * Methods to manage {@link LocomotionType} objects in persistent storage.
 */
public interface LocomotionTypeDao {
	/**
	 * Retrieves a LocomotionType object from persistent storage.
	 *
	 * @param id  the id of the LocomotionType object to retrieve
	 * @return the LocomotionType instance with the given id or null if not found.
	 */
	public LocomotionType getById(int id);

	/**
	 * Retrieves all LocomotionType objects from persistent storage.
	 *
	...
	/**
	 * Delete the LocomotionType object with the given id from persistent storage.
	 *
	 * @param id  the id of the LocomotionType object to delete
	 * @return true if successful, otherwise false.
	 */
	public boolean deleteById(int id);

	/**
	 * Delete all LocomotionType objects from persistent storage.
	 *
