...
/**
 * Database schema data for the creature_talents table
 */
public interface CreatureTalentsSchema {
    String TABLE_NAME = "creature_talents";
    ...
    String[] COLUMNS = new String[] {COLUMN_ID, COLUMN_CREATURE_ID, COLUMN_TALENT_ID, COLUMN_TIERS};
}
