...
public interface CharacterSchema {
	...
	String[] COLUMNS = new String[] {COLUMN_ID, COLUMN_EXPERIENCE_POINTS, COLUMN_FIRST_NAME, COLUMN_LAST_NAME, COLUMN_KNOWN_AS,
			COLUMN_DESCRIPTION, COLUMN_HAIR_COLOR, COLUMN_HAIR_STYLE, COLUMN_EYE_COLOR, COLUMN_SKIN_COMPLEXION,
			COLUMN_FACIAL_FEATURES, COLUMN_IDENTIFYING_MARKS, COLUMN_PERSONALITY, COLUMN_MANNERISMS, COLUMN_HOMETOWN,
			COLUMN_FAMILY_INFO, COLUMN_RACE_ID, COLUMN_CULTURE_ID, COLUMN_PROFESSION_ID, COLUMN_REALM_ID, COLUMN_HEIGHT,
