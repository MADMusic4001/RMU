...
public interface SizeDao {
	 ...
	 * Retrieves a Size object from persistent storage.
	 *
	 * @param code  the code of the Size object to retrieve
	 * @return the Size instance with the given id or null if not found.
	 */
	Size getByCode(String code);
	 ...
	 */
	boolean save(Collection<Size> instance, boolean isNew);
	 ...
	 * @return true if successful, otherwise false.
	 */
	boolean save(Collection<Size> instance);
