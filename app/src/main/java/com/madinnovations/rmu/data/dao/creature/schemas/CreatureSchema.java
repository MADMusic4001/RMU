...
public interface CreatureSchema {
	...
	String COLUMN_CREATURE_ARCHETYPE_ID = "creatureArchetypeId";
	String COLUMN_LEVEL = "level";
	String COLUMN_MAX_HITS = "maxHits";
	String COLUMN_CURRENT_HITS = "currentHits";
	String COLUMN_CURRENT_DPS = "currentDevelopmentPoints";
	String COLUMN_BASE_MOVEMENT_RATE = "baseMovementRate";
	String COLUMN_NUM_CREATURES = "numCreatures";
	...
	String TABLE_CREATE = "CREATE TABLE IF NOT EXISTS "
			...
			+ COLUMN_CREATURE_ARCHETYPE_ID + " INTEGER NOT NULL REFERENCES "
				+ CreatureArchetypeSchema.TABLE_NAME + "(" + CreatureArchetypeSchema.COLUMN_ID + "), "
			+ COLUMN_LEVEL + " INTEGER NOT NULL, "
			+ COLUMN_MAX_HITS + " INTEGER NOT NULL, "
			+ COLUMN_CURRENT_HITS + " INTEGER NOT NULL, "
			+ COLUMN_CURRENT_DPS + " INTEGER NOT NULL, "
			+ COLUMN_BASE_MOVEMENT_RATE + " INTEGER NOT NULL, "
			+ COLUMN_NUM_CREATURES + " INTEGER NOT NULL"
			+ ")";

	String[] COLUMNS = new String[] { COLUMN_ID, COLUMN_CAMPAIGN_ID, COLUMN_CREATURE_VARIETY_ID, COLUMN_CREATURE_ARCHETYPE_ID,
			COLUMN_LEVEL, COLUMN_MAX_HITS, COLUMN_CURRENT_HITS, COLUMN_CURRENT_DPS, COLUMN_BASE_MOVEMENT_RATE,
			COLUMN_NUM_CREATURES};
}
