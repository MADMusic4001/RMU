 ...
 */
public interface CombatSetupSchema {
	String TABLE_NAME = "combat_setups";

	String COLUMN_ID                 = "id";
	String COLUMN_CAMPAIGN_ID        = "campaignId";
	String COLUMN_CURRENT_INITIATIVE = "currentInitiative";
	String COLUMN_COMBAT_START_TIME  = "combatStartTime";
	...
	String TABLE_CREATE = "CREATE TABLE IF NOT EXISTS "
			...
			+ COLUMN_COMBAT_START_TIME + " INTEGER NOT NULL"
			+ ")";

	String[] COLUMNS = new String[] {COLUMN_ID, COLUMN_CAMPAIGN_ID, COLUMN_CURRENT_INITIATIVE, COLUMN_COMBAT_START_TIME};
}
