...
public interface BodyPartDao {
    ...
    /**
     * Saves a collection of BodyPart instances to persistent storage.
     *
     * @param instance  the collection of BodyPart instances to be saved
     * @param isNew  set to true if the instances have valid IDs but should be inserted instead of updated.
     * @return true if successful, otherwise false.
     */
    public boolean save(Collection<BodyPart> instance, boolean isNew);
     ...
     * @return true if successful, otherwise false.
     */
    public boolean save(Collection<BodyPart> instance);
