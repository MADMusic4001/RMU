...
/**
 * Database schema data for the profession_assignable_skill_costs table
 */
public interface ProfessionAssignableSkillCostSchema {
	String TABLE_NAME = "profession_assignable_skill_costs";
