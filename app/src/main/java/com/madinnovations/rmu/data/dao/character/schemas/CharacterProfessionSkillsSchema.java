...
/**
 * Database schema data for the character_profession_skills table
 */
public interface CharacterProfessionSkillsSchema {
    String TABLE_NAME = "character_profession_skills";
