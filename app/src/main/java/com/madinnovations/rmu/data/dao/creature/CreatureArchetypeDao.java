...
/**
 * Methods to manage {@link CreatureArchetype} objects in persistent storage.
 */
public interface CreatureArchetypeDao {
	/**
	 * Retrieves a CreatureArchetype object from persistent storage.
	 *
	 * @param id  the id of the CreatureArchetype object to retrieve
	 * @return the CreatureArchetype instance with the given id or null if not found.
	 */
	public CreatureArchetype getById(int id);

	/**
	 * Retrieves all CreatureArchetype objects from persistent storage.
	 *
	 ...
	 *
	 * @param instance  the CreatureArchetype object to be saved
	 * @return true if successful, otherwise false.
	 */
	public boolean save(CreatureArchetype instance);

	/**
	 * Delete the CreatureArchetype object with the given id from persistent storage.
	 *
	 * @param id  the id of the CreatureArchetype object to delete
	 * @return true if successful, otherwise false.
	 */
