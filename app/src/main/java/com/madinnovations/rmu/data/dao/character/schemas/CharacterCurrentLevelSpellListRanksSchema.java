...
/**
 * Database schema data for the character_current_level_spell_list_ranks table
 */
public interface CharacterCurrentLevelSpellListRanksSchema {
    String TABLE_NAME = "character_current_level_spell_list_ranks";
