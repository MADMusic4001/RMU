...
public interface TalentCategoryDao {
	...
	/**
	 * Saves a collection of TalentCategory instances to persistent storage.
	 *
	 * @param instance  the collection of TalentCategory instances to be saved
	 * @param isNew  set to true if the instances have valid IDs but should be inserted instead of updated.
	 * @return true if successful, otherwise false.
	 */
	public boolean save(Collection<TalentCategory> instance, boolean isNew);
	 ...
	 * @return true if successful, otherwise false.
	 */
	public boolean save(Collection<TalentCategory> instance);
