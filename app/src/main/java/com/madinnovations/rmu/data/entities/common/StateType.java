...
public enum StateType {
	...
	/**
	 * Gets the StateType instance with the given localized name.
	 *
	 * @param name  the localized name whose StateType instance is to be returned
	 * @return  a StateType instance with the given localized name or null if not found.
	 */
