...
public interface TalentSchema {
	...
	String COLUMN_IS_CREATURE_ONLY = "isCreatureOnly";

	String TABLE_CREATE = "CREATE TABLE IF NOT EXISTS "
			+ TABLE_NAME
			+ " ("
			+ COLUMN_ID + " INTEGER PRIMARY KEY, "
			+ COLUMN_CATEGORY_ID + " INTEGER NOT NULL REFERENCES "
				+ TalentCategorySchema.TABLE_NAME + "(" + TalentCategorySchema.COLUMN_ID + "), "
			...
			+ COLUMN_IS_CREATURE_ONLY + " INTEGER NOT NULL"
			+ ")";
	...
	String[] COLUMNS = new String[] { COLUMN_ID, COLUMN_CATEGORY_ID, COLUMN_NAME, COLUMN_DESCRIPTION, COLUMN_IS_FLAW,
			...
			COLUMN_ACTION, COLUMN_IS_CREATURE_ONLY};
}
