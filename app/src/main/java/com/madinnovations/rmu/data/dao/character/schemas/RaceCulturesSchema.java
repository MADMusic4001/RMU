...
/**
 * Database schema data for the race_cultures table
 */
public interface RaceCulturesSchema {
	String TABLE_NAME = "race_cultures";
	...
	String TABLE_CREATE = "CREATE TABLE IF NOT EXISTS "
			...
			+ "PRIMARY KEY (" + COLUMN_RACE_ID + "," + COLUMN_CULTURE_ID + ")"
			+ ")";

	String[] COLUMNS = new String[] {COLUMN_RACE_ID, COLUMN_CULTURE_ID};
}
