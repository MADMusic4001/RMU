...
/**
 * Database schema data for the talent_stats table
 */
public interface TalentStatsSchema {
	String TABLE_NAME = "talent_stats";
	...
	String TABLE_CREATE = "CREATE TABLE IF NOT EXISTS "
			...
			+ "PRIMARY KEY(" + COLUMN_TALENT_ID + "," + COLUMN_STAT_ID + "), "
	...
	String[] COLUMNS = new String[] {COLUMN_TALENT_ID, COLUMN_STAT_ID, COLUMN_VALUE};
}
