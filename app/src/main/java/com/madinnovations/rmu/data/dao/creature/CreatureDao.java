...
/**
 * Methods to manage {@link Creature} objects in persistent storage.
 */
public interface CreatureDao {
	...
	/**
	 * Saves a collection of Creature instances to persistent storage.
	 *
	 * @param instance  the collection of Creature instances to be saved
	 * @param isNew  set to true if the instances have valid IDs but should be inserted instead of updated.
	 * @return true if successful, otherwise false.
	 */
	public boolean save(Collection<Creature> instance, boolean isNew);
