...
/**
 * Populates a Spinner with {@link Range} information
 */
public class RangeSpinnerAdapter extends ArrayAdapter<Range> {
	private static final int LAYOUT_RESOURCE_ID = R.layout.spinner_row;
	private LayoutInflater layoutInflater;

	/**
	 * Creates a new RangeSpinnerAdapter instance.
	 *
	 * @param context the view {@link Context} the adapter will be attached to.
	 */
	@Inject
	public RangeSpinnerAdapter(Context context) {
