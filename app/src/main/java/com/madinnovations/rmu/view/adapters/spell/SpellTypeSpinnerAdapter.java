...
/**
 * Populates a Spinner with {@link SpellType} information
 */
public class SpellTypeSpinnerAdapter extends ArrayAdapter<SpellType> {
	private static final int LAYOUT_RESOURCE_ID = R.layout.spinner_row;
	private LayoutInflater layoutInflater;

	/**
	 * Creates a new SpellTypeSpinnerAdapter instance.
	 *
	 * @param context the view {@link Context} the adapter will be attached to.
	 */
	@Inject
	public SpellTypeSpinnerAdapter(Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		SpellType item = getItem(position);
