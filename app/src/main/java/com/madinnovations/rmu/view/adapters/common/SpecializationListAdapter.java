...
/**
 * Populates a ListView with {@link Specialization} information
 */
public class SpecializationListAdapter extends ArrayAdapter<Specialization> {
	private static final int LAYOUT_RESOURCE_ID = R.layout.name_description_row;
	private LayoutInflater layoutInflater;

	/**
	 * Creates a new SpecializationListAdapter instance.
	 *
	 * @param context the view {@link Context} the adapter will be attached to.
	 */
	@Inject
	public SpecializationListAdapter(Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.nameView.setText(specialization.getName());
		holder.descriptionView.setText(specialization.getDescription());
		return rowView;
	}
