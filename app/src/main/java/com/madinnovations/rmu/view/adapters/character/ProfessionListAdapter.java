...
/**
 * Populates a ListView with {@link Profession} information
 */
public class ProfessionListAdapter extends ArrayAdapter<Profession> {
	private static final int LAYOUT_RESOURCE_ID = R.layout.name_description_row;
	private LayoutInflater layoutInflater;

	/**
	 * Creates a new ProfessionListAdapter instance.
	 *
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Profession profession = getItem(position);
		holder.nameView.setText(profession.getName());
		holder.descriptionView.setText(profession.getDescription());
		return rowView;
	}
