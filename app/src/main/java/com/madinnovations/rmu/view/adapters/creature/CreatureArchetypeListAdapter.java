...
public class CreatureArchetypeListAdapter extends ArrayAdapter<CreatureArchetype> {
	...
	/**
	 * Creates a new CreatureArchetypeListAdapter instance.
	 *
	 * @param context the view {@link Context} the adapter will be attached to.
	 */
	@Inject
	public CreatureArchetypeListAdapter(Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		CreatureArchetype creatureArchetype = getItem(position);
		holder.nameView.setText(creatureArchetype.getName());
		holder.descriptionView.setText(creatureArchetype.getDescription());
		return rowView;
	}
