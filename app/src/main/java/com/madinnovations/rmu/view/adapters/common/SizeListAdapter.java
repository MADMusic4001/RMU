...
public class SizeListAdapter extends ArrayAdapter<Size> {
	...
	/**
	 * Creates a new SizeListAdapter instance.
	 *
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Size stat = getItem(position);
		holder.codeView.setText(stat.getCode());
		holder.nameView.setText(stat.getName());
		holder.examplesView.setText(stat.getExamples());
		return rowView;
	}
	...
	private class ViewHolder {
		...
		ViewHolder(TextView codeView, TextView nameView, TextView examplesView) {
