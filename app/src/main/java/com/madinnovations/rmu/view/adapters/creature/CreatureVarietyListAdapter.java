...
public class CreatureVarietyListAdapter extends ArrayAdapter<CreatureVariety> {
	...
	/**
	 * Creates a new CreatureVarietyListAdapter instance.
	 *
	 * @param context the view {@link Context} the adapter will be attached to.
	 */
	@Inject
	public CreatureVarietyListAdapter(Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		CreatureVariety creatureVariety = getItem(position);
		holder.nameView.setText(creatureVariety.getName());
		holder.descriptionView.setText(creatureVariety.getDescription());
		return rowView;
	}
