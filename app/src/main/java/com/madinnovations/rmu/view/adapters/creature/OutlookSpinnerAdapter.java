...
/**
 * Populates a Spinner with {@link Outlook} information
 */
public class OutlookSpinnerAdapter extends ArrayAdapter<Outlook> {
	private static final int LAYOUT_RESOURCE_ID = R.layout.spinner_row;
	private LayoutInflater layoutInflater;

	/**
	 * Creates a new OutlookSpinnerAdapter instance.
	 *
	 * @param context the view {@link Context} the adapter will be attached to.
	 */
	@Inject
	public OutlookSpinnerAdapter(Context context) {
