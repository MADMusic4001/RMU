...
/**
 * Populates a Spinner with {@link SpellSubType} information
 */
public class SpellSubTypeSpinnerAdapter extends ArrayAdapter<SpellSubType> {
	private static final int LAYOUT_RESOURCE_ID = R.layout.spinner_row;
	private LayoutInflater layoutInflater;

	/**
	 * Creates a new SpellSubTypeSpinnerAdapter instance.
	 *
	 * @param context the view {@link Context} the adapter will be attached to.
	 */
	@Inject
	public SpellSubTypeSpinnerAdapter(Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		SpellSubType item = getItem(position);
