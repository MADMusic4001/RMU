...
/**
 * Populates a Spinner with {@link SpellListType} information
 */
public class SpellListTypeSpinnerAdapter extends ArrayAdapter<SpellListType> {
	private static final int LAYOUT_RESOURCE_ID = R.layout.spinner_row;
	private LayoutInflater layoutInflater;

	/**
	 * Creates a new SpellListTypeSpinnerAdapter instance.
	 *
	 * @param context the view {@link Context} the adapter will be attached to.
	 */
	@Inject
	public SpellListTypeSpinnerAdapter(Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		SpellListType item = getItem(position);
