...
/**
 * Populates a Spinner with {@link CreatureType} information
 */
public class CreatureTypeSpinnerAdapter extends ArrayAdapter<CreatureType> {
	private static final int LAYOUT_RESOURCE_ID = R.layout.name_row;
	private LayoutInflater layoutInflater;

	/**
	 * Creates a new CreatureTypeSpinnerAdapter instance.
	 *
	 * @param context the view {@link Context} the adapter will be attached to.
	 */
	@Inject
	public CreatureTypeSpinnerAdapter(Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		CreatureType item = getItem(position);
