...
/**
 * Populates a Spinner with {@link Duration} information
 */
public class DurationSpinnerAdapter extends ArrayAdapter<Duration> {
	private static final int LAYOUT_RESOURCE_ID = R.layout.spinner_row;
	private LayoutInflater layoutInflater;

	/**
	 * Creates a new DurationSpinnerAdapter instance.
	 *
	 * @param context the view {@link Context} the adapter will be attached to.
	 */
	@Inject
	public DurationSpinnerAdapter(Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Duration item = getItem(position);
