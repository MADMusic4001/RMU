...
/**
 * Populates a Spinner with {@link Realm} information
 */
public class RealmSpinnerAdapter extends ArrayAdapter<Realm> {
	private static final int LAYOUT_RESOURCE_ID = R.layout.spinner_row;
	private LayoutInflater layoutInflater;

	/**
	 * Creates a new RealmSpinnerAdapter instance.
	 *
