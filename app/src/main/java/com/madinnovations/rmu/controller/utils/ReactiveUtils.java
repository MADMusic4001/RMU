...
public class ReactiveUtils {
	...
	public Observable<?> getGetSingleParameterObservable(Handler handler, Object parameter) {
		Observable<?> result = null;

		switch (handler) {
			case SPELL_RX_HANDLER:
				result = spellRxHandler.getSpellsForList((SpellList) parameter);
				break;
			case CREATURE_TYPE_RX_HANDLER:
				result = creatureTypeRxHandler.getTypesForCategory((CreatureCategory) parameter);
				break;
			case CREATURE_VARIETY_RX_HANDLER:
				result = creatureVarietyRxHandler.getVarietiesForType((CreatureType) parameter);
				break;
		}
